...
class NoticiaRequest extends FormRequest
{
    ...
    public function messages(){
        return[
        'titulo.required' => 'O campo t[itulo é obrigatório',
        'conteudo.required' => 'O campo conteúdo é obrigatório',
        'status.required' => 'O campo status é obrigatóiro',
        'data_publicacao.required' => 'O campo data publicação é obrigatório',
